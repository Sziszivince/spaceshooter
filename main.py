...
def play():
    pygame.mixer.music.load("C:/Users/admin/Downloads/Music.mp3")
...
pygame.display.set_caption("SZISZI SPACE SHOOTER")
...
explosion_sound = pygame.mixer.Sound(os.path.join("music", "music_explosion.wav"))
laser_sound = pygame.mixer.Sound(os.path.join("music", "music_laser.wav"))
